...
<div class="content">
	<h3 class="content-subhead">Edit Career Posting</h3>
	<div class="pure-g">
		<div class="pure-u-1">
			{{ Form::open(array('route' => ['admin.postings.update', $posting->id], 'class' => 'pure-form pure-form-aligned','files' => true)) }}
				<fieldset>
					<div class="pure-control-group">
						{{ Form::label('Title', null) }}
						{{ Form::text('title', $posting->title, array('placeholder' => 'Title')) }}
					</div>

					<div class="pure-control-group">
						{{ Form::label('Company Name', null) }}
						{{ Form::text('company_name', $posting->company_name, array('placeholder' => 'Company Name')) }}
					</div>

					<div class="pure-control-group">
						{{ Form::label('Internal Posting') }}
						@if($posting->external)
							{{ Form::radio('external', '0') }} Yes
							{{ Form::radio('external', '1', true) }} No
						@else
              ...
              <option value="Other">Other</option>
					...
					<div class="pure-control-group">
						...
						{{ Form::textarea('description', $posting->description, array('placeholder' => 'Description')) }}
					</div>
